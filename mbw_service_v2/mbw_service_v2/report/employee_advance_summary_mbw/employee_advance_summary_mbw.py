...
def get_columns():
	return [
		...
		{"label": _("Pending Amount"), "fieldname": "pending_amount", "fieldtype": "Data", "width": 120},
		{"label": _("Returned Amount"), "fieldname": "return_amount", "fieldtype": "Data", "width": 120},
...
def get_advances(filters):
	...
	return  frappe.db.sql(
		"""select name, employee, paid_amount, status, advance_amount, pending_amount, return_amount, claimed_amount, company,
