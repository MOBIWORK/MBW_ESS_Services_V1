...
# Get the doctype
TimeSheetPosition = frappe.qb.DocType('ESS ESS TimeSheet Position')
TimeSheetWifi = frappe.qb.DocType('TimeSheet Wifi')
TimeSheetWifiIntermediate = frappe.qb.DocType('ESS ESS TimeSheet Wifi intermediate')
EmployeeChild = frappe.qb.DocType('ESS ESS Employee Child')
